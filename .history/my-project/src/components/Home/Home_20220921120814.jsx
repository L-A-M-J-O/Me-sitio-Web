            ...
            <div id='home' className='container'>
                <div className='menu'>
                    <ul className='social-media'>
                        ...
                        <li>
                            <Link href='https://www.instagram.com/aelan__30/' className='media-icon'>
        ...
        <div className='glass'>
            ...
            <div>
                ...
                <div>
                    ...
                    <p>amet consectetur adipisicing elit. Eius molestias placeat quam expedita, nemo perferendis dolorum dolor sed iure. Illum.</p>
                    <Link to='' className='media-icon'>
