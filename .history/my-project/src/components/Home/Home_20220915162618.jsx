    ...
    <div className='container-fluid p-0 m-0'>
        ...
        <div className='row justify-content-end me-3 m-hero-menu'>
          <div className='col-12 text-end'>
            <Link to="test1" spy={true} smooth={true} offset={50} duration={500}><h2><span>ME</span></h2></Link>  
            <h2><span>JOB</span></h2>
            <Link to="test1" spy={true} smooth={true} offset={50} duration={500}><h2><span>ABOUT</span></h2></Link>
