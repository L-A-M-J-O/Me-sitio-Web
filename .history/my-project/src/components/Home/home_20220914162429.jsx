              ...
              <div className='content-me'>
                <div className='details'>
                  ...
                  <div className='m-skills'>
                    ...
                    <h4>CSS3<br/><span>80%</span></h4>
                    <h4>JAVASCRITP<br/><span>80%</span></h4>
                    {/* <h4>REACT JS<br/><span>80%</span></h4>
                    <h4>MEDETOLOGIA<br/><span>80%</span></h4>
                    <h4>GIT<br/><span>80%</span></h4>
                    <h4>JAVA<br/><span>80%</span></h4>
                    <h4>C<br/><span>80%</span></h4>
                    <h4>MySQL<br/><span>80%</span></h4> */}
                  </div>
                </div>
              </div>
            </div>
