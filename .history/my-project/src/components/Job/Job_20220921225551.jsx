    ...
    <div id='job'>
       ...
       <div className='row card-job-main align-items-center'>
        ...
        <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
          ...
          <span className="small text-muted span-description">Team QA</span>
            <p className="card-text">My job in this position was, <br/>
            My job in this position was, - Creation of project from scratch with organization and routing with react js - Creation of HTML and CSS structure Design of all mobile and desktop design. - Creation of functions - Meetings with all colleagues to organize ideas.
              </p>
          </div>
        </div>
        </div>
