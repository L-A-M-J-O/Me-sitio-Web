            ...
            <div className='row d-flex justify-content-evenly mt-5'>
                <div className='col-10 pt-2'>
                    ...
                    <div className="card-job">
                        <img src="https://media-exp1.licdn.com/dms/image/C4E0BAQHVWeqmIAjzAw/company-logo_200_200/0/1522233689880?e=2147483647&v=beta&t=sNf-YB9yxGLVqyLa_xykMX7PCG1eaWAJ9LH2kuqItHU" className="card-img-top img-fluid" alt="..."/>
