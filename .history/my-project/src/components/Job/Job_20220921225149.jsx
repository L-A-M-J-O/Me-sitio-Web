...
function Job() {
  return (
    <div id='job'>
        <p>I had the opportunity to participate in a work group like No country and start working in a company</p>
       <div className='row card-job-main align-items-center'>
        <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
          <div className="card-job mb-4 mb-sm-0 mb-md-0 mb-lg-0">
        ...
        <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
          ...
          <div className="card-body">
          <span className="small text-muted span-description">Front-end Developer</span>
            <p className="card-text">My job in this position was,
            <br/>
