                ...
                <div className='col-12 pt-2'>
                    ...
                    <div className="card-job-n">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">Estuve trabajando por 6 meses en el equipo de QA</p> 
                            <p className="card-text">Las hababilidades que requeria el trabajo era verificacion de SEO FRONT-END</p> 
                        </div>
                        </div>
                        </div>
                        <div className='col-7 col-sm-10 col-md-3 col-lg-3'>
