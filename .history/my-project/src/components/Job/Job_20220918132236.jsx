                ...
                <div className='col-12 pt-2'>
                    ...
                    <div className="card-job-n">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">Front-End, Estuve realizando un proyecto de un icomerce en un grupo de 4 personas 2 front-end 1 back-end y UX-UI, Las habilidadades trabajo en equipo y comunicacion continua e  realizacion de versionamietos y programacion de eventos</p> 
                        </div>
                    </div>
                        </div>
                    </div>
