...
function Job() {
  return (
    <div id='job'>
      <div className='row me-0 justify-content-center mt-5'>
        <div className='col-1 texte-center m-0'>
        <img src={company} alt='frase de compañia' width={25}/>
        </div>
        <div className='col-8 m-0 text-start'>
      ...
      <div className='m-hero-job row justify-content-center me-0'>
