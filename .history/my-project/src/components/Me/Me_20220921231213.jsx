...
function Me() {
  return (
    ...
    <div className='container-fluid p-0' id='about'>
      <div className='row justify-content-center justify-content-sm-start justify-content-md-around justify-content-lg-around m-hero-me align-items-center m-0'>
