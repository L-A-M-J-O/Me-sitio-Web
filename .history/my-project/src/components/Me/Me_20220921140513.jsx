            ...
            <li class="list-group-item bg-transparent border-bottom py-3 px-0">
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <span class="small text-muted span-description">Lenguaje de marcado, Paginas Web</span>
                  </div>
                  <div class="col">
          ...
          <li class="list-group-item bg-transparent border-bottom py-3 px-0">
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <span class="small text-muted span-description">Lenguaje de Programacion</span>
                  </div>
                  <div class="col">
                      <span class="fs-6 fw-bolder">$1,834</span>
                  </div>
          ...
          <li class="list-group-item bg-transparent border-bottom py-3 px-0">
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <span class="small text-muted span-description">Framework CSS3, Sitios mobile first</span>
                  </div>
                  <div class="col">
                      <span class="fs-6 fw-bolder">$1,834</span>
                  </div>
