...
function Me() {
  return (
    ...
    <div className='container-fluid p-0' id='about'>
      <div className='row justify-content-center justify-content-sm-around justify-content-md-around justify-content-lg-around m-hero-me align-items-center m-0'>
        <div className='col-12 col-sm-12 col-md-12 col-lg-5 mb-4'>
          <div className="card">
