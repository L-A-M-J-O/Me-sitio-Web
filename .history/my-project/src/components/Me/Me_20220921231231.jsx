...
function Me() {
  return (
    ...
    <div className='container-fluid p-0' id='about'>
      <div className='row justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center m-hero-me align-items-center m-0'>
