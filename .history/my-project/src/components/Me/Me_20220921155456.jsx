              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <div class="col">
                    <div className='block'>
                      <div className='box'>
                        <img src='https://e7.pngegg.com/pngimages/328/221/png-clipart-c-programming-language-logo-microsoft-visual-studio-net-framework-javascript-icon-purple-logo.png' alt='Javascript'/>
                      </div>
                    </div>
                  </div>
              </div>
