          ...
          <div className='m-skills-hero'>
            ...
            <div className='list'>
              ...
              <div className='m-skills'>
                ...
                <h4>CSS3</h4>
                <p>Lenguaje de diseño gráfico</p>
              </div>
            </div>
            <div className='list'>
              <div className='imgBx'>
            ...
            <div className='list'>
              <div className='imgBx'>
                <img src='https://sass-lang.com/assets/img/styleguide/seal-color-aef0354c.png' alt='BEM'/>
              </div>
              <div className='m-skills'>
                <h2 className='rank'><small>#6</small></h2>
                <h4>BEM</h4>
                <p>Lenguaje estructurado</p>
              </div>data:image/png;base64,
            </div>
            <div className='list'>
              <div className='imgBx'>
                <img src={git} alt='GIT'/>
