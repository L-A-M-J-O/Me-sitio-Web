              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <div class="col">
                    <div className='block'>
                      <div className='box'>
                        <img src='https://w7.pngwing.com/pngs/18/497/png-transparent-black-and-blue-atom-icon-screenshot-react-javascript-responsive-web-design-github-angularjs-github-logo-electric-blue-signage.png' alt='Javascript'/>
                      </div>
                    </div>
                  </div>
              </div>
