              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <div class="col">
                    <div className='block'>
                      <div className='box'>
                        <img src='https://img2.freepng.es/20180711/luz/kisspng-sass-style-sheet-language-cascading-style-sheets-l-sass-5b462192244b94.2444958315313227701487.jpg' alt='Booststrap V5'/>
                      </div>
                    </div>
                  </div>
              </div>
