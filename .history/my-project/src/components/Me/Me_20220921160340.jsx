              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <div class="col">
                    <div className='block'>
                      <div className='box'>
                        <img src='https://img1.freepng.es/20180420/hbe/kisspng-sass-cascading-style-sheets-preprocessor-less-post-meng-5adaa47c6d07f0.0738015115242783964466.jpg' alt='Booststrap V5'/>
                      </div>
                    </div>
                  </div>
              </div>
