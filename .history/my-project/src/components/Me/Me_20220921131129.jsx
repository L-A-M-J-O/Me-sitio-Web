  ...
  return (
    ...
    <div className='container-fluid'>
      <div className='row justify-content-center'>
        ...
        <div class="list-group-item bg-transparent border-bottom py-3 px-0 aa">
    <div class="row align-items-center">
        <div class="col-auto">
            <a href="#" class="user-avatar rounded bordered">
                <img class="p-1 rounded" alt="Image placeholder" src="https://cdn.worldvectorlogo.com/logos/html-1.svg" width={50}/>
            </a>
        </div>
