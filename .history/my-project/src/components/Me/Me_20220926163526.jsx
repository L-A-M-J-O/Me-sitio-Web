...
function Me() {
  return (
    <>  
    <div className='container-me container-fluid' id='about'>
      <div className='row justify-content-center justify-content-sm-center justify-content-md-around justify-content-lg-around m-hero-me align-items-center m-0 mt-4'>
        ...
        {/* <div className='col-12 col-sm-12 col-md-5 col-lg-5'>
          <div className='m-skills-hero'>
            ...
            <div className='list'>
              <div className='imgBx'>
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Angular_full_color_logo.svg/2048px-Angular_full_color_logo.svg.png' alt='Angular Js'/>
              </div>
              <div className='m-skills'>
            ...
            <div className='list'>
              <div className='imgBx'>
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Kotlin_Icon.svg/1200px-Kotlin_Icon.svg.png' alt='Kotlin'/>
              </div>
              <div className='m-skills'>
