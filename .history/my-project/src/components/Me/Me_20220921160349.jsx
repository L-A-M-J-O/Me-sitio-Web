              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="col-auto px-0">
                  ...
                  <div class="col">
                    <div className='block'>
                      <div className='box'>
                        <img src='https://e7.pngegg.com/pngimages/72/936/png-clipart-sass-cascading-style-sheets-preprocessor-less-postcss-meng-miscellaneous-text-thumbnail.png' alt='Booststrap V5'/>
                      </div>
                    </div>
                  </div>
              </div>
