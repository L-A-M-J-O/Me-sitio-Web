...
function Navbar() {
  return (
    <section>
      ...
      <ul className='sci'>
          <li><a href='#'><img className='img-R' src={linkedin} alt='linkedin' width={36}/></a></li>
          <li><a href='#'><img className='img-R'  src={github} alt='Github'width={36}/></a></li>
          <li><a href='#'><img className='img-R'  src={facebook} alt='facebok' width={36}/></a></li>
        </ul>
    </section>
  )
}
