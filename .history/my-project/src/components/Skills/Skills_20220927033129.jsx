          ...
          <div className='col-7'>
           <div className='row'>
            ...
            <div className='col-4'>
              ...
              <div className='col-2 m-0 p-2'>
                <div className='m-img'>
                  <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.pnghttps://getbootstrap.com/docs/5.0/assets/brand/bootstrap-logo.svg' alt='Bootstrap v5'/>
                </div>
              </div>
              <div className='col-1 m-0 p-0 align-self-center'>
                <span>#1</span>
