        ...
        <div className='row m-hero-runa justify-content-end'>
          ...
          <div className='m-hero-runa-box'>
            <div className='bubbles'>
              <span><img src={ runa } alt='runa' width={100 } height={100}/></span>
              <span><img src={ runa1 } alt='runa' width={100 } height={100}/></span>
              <span><img src={ runa2 } alt='runa' width={100 } height={100}/></span>
              <span><img src={ runa3  } alt='runa' width={100 } height={100}/></span>
              <span><img src={ runa4 } alt='runa' width={100 } height={100}/></span>
            </div>
