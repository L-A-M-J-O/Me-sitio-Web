                ...
                <div className='details mt-5'>
                  ...
                  <div className='m-skills'>
                    <div className='row m-skills-r justify-content-center'>
                      <div className='col-3'>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum doloremque minima accusamus ipsam optio, facere placeat ex tempora sunt exercitationem sit ipsa? Perferendis, dolorum voluptas nulla recusandae et excepturi mollitia!</p>
                      </div>
                    </div>
                  </div>
                </div>
