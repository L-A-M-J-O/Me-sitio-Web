            ...
            <div className='col-12'>
              <div className='card-history'>
                ...
                <div className='content-me-history'>
                  <div className='details-h mt-5'>
                  {/* <h3 className='h2-tittle'>Alan Naranjo<br/><span className='m-hero-title-h'>Developer Front-end</span></h3> */}
                  <div className='m-skills-h'>
                    <div className='row m-skills-h justify-content-center'>
                      <div className='col-3'>
