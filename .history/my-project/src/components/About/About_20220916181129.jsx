  ...
  return (
    <section id='about'>
      ...
      <div className='row justify-content-center me-3 m-hero-about'>
        ...
        <div className='row m-hero-runa justify-content-center'>
          <div className='col-2'>
          ...
          <div className='col-6 m-hero-tittle align-self-center'>
          <div className="Main_line__vX9br"></div>
          </div>
          <div className='col-1 m-hero-tittle align-self-center'>
